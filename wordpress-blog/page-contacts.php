        ...
        <section class="contacts">
            <div class="container contacts__container">
                ...
                <div class="contacts__left">
                    ...
                    <address class="address">г. Харьков, ул. Харьковская, 3</address>
                    <ul class="social list-reset">
                        <li class="social__item">
                            <a href="#" class="social__link social__link--fb" aria-label="Наш фейсбук"></a>
                        </li>
                        <li class="social__item">
                            <a href="#" class="social__link social__link--vk" aria-label="Наш вконтакте"></a>
                        </li>
                        <li class="social__item">
                ...
                <div class="contacts__right">
                    <div class="contacts-form-wrapper">
                        ...
                        <form action="<?php echo admin_url('admin-ajax.php?action=callback_mail') ?>" class="callback-form">
                            ...
                            <input type="tel" name="tel" class="form-input callback-form__input" placeholder="Телефон или E-mail">
